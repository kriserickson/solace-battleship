...
public class GameEngineTest {
    ...
    public void testRequestToMakeMovePlayer1Miss() {
        ...
        KnownBoardCellState[][] mockedBoard = {
                { KnownBoardCellState.empty, KnownBoardCellState.empty, KnownBoardCellState.empty,
                        KnownBoardCellState.empty, KnownBoardCellState.empty },
                { KnownBoardCellState.empty, KnownBoardCellState.empty, KnownBoardCellState.empty,
                        KnownBoardCellState.empty, KnownBoardCellState.empty },
                { KnownBoardCellState.empty, KnownBoardCellState.empty, KnownBoardCellState.empty,
                        KnownBoardCellState.empty, KnownBoardCellState.empty },
